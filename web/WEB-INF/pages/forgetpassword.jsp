        ...
        <div class="container-fluid" style="background-color: beige">
            <div class="container center_div ">
                ...
                <div class="row" style="height: 150px;width: 100%">
                    <div class="col-md-12">
                        <form action="/E-Commerce/fc/?page=ForgetPassword&type=model" method="post" ><br>

                            <input class="form-control " id="eid" placeholder="user id" onblur="loginVerify('eid', 'sid')" type="text" name="email" ><span id="sid"></span><br>
                            <input type="submit" name="login" class="btn btn-primary ">
